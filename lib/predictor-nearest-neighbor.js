...
;(function(){
   ...
   *
   * @param {observation} newObservation the new observation to be classified
   * @param {Array<observation>} pastObservations all past observations to consider
   * @returns {scores} likelihood scores that newObservation is a member of any class
   */
