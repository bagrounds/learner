...
;(function () {
  ...
  var defaultPredictor = require('./predictor-neural-network');
  ...
  Learner.prototype.__defineGetter__('observations', function () {
    return privateMembers.observations;
  });
  Learner.prototype.__defineGetter__('model', function () {
    return privateMembers.model;
  });
  ...
  function observe(options, callback) {
    ...
    callback(error, privateMembers.observations.length + ' observations.');
  }
